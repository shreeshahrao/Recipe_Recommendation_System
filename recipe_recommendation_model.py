...
food_res = pd.read_csv('new_recipe_dataset.csv')
food_dataset = food_res
...
for i in range(len(saperated_ingred)):
  ...
  #str_recipe1= ','.join(recipe_ingrdiants)
  ...
  #final_dataset.IngredientsList.iloc[i] = str_recipe1


#print(final_dataset['TranslatedRecipeName'].tail(10))
#print(final_dataset['TranslatedIngredients'].tail(10))
#print(final_dataset['IngredientsList'].tail(10))
#inal_dataset.to_csv("new_recipe_dataset.csv")
...
def recommendation(X):
  ...
  for i in top_5:
    ...
    l2.append(final_dataset.iloc[i][11])
  return l1,l2
